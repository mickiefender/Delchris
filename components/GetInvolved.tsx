  ...
  return (
    <section id="get-involved" className="py-20 md:py-32 bg-card">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Why Join Delchris */}
        <div className="bg-white rounded-xl p-12 border border-border mb-16">
          <h3 className="text-2xl font-bold text-foreground mb-8 text-center">Why Join the Delchris Team</h3>
        ...
        {/* CTA Section */}
        <div className="bg-gradient-to-r from-primary to-primary/80 rounded-xl p-12 text-white text-center">
